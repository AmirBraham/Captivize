...
// For instance:
// - Hero: "Captivize helps developers launch startups fast"
// - Problem Agitation: "Developers spend too much time adding features, get overwhelmed, and quit." (not about Captivize at all)
// - Features: "Captivize has user auth, Stripe, emails all set up for you"
const Problem = () => {
  return (
